...
// Middleware for parsing JSON requests (in case you need it for POST requests)
...
// Sample job data for initial population (can be removed if you already have data in your DB)
const Jobs = [
...
// Populate the database with sample jobs (this is for initial use)
app.post('/api/populate', async (req, res) => {
    try {
        await Job.insertMany(sampleJobs);
        res.send('Database populated with sample jobs');
    } catch (err) {
